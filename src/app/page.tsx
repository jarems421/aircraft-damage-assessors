...
export const metadata = pageMetadata("Aircraft damage assessment", "Aircraft damage assessment, detailed damage reports, parts estimates and repairability assessment for insurers, brokers, aircraft owners and operators.");
export default function HomePage() {
  return <>
    <section className="home-hero"><div className="site-width hero-grid">
      <div className="hero-copy"><p className="eyebrow">Aircraft Damage Assessors Ltd</p><h1>Aircraft damage.<br /><em>A clearer picture.</em></h1><p className="hero-description">Aircraft damage assessment and detailed reporting for insurers, brokers, aircraft owners and operators.</p><Link href="/contact" className="button button-light">Request an assessment <span aria-hidden="true">↗</span></Link><TextLink href="/damage-assessment">Explore the assessment scope</TextLink></div>
      <AircraftExplorer />
    </div><div className="site-width hero-baseline"><span>Aircraft damage assessment & aviation technical services</span><span>Explore below <span aria-hidden="true">↓</span></span></div></section>
