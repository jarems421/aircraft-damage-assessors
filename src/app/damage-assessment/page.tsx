...
export const metadata = pageMetadata("Damage assessment", "Aircraft damage reporting, parts requirements, estimated costs, repairability, potential cause and third-party AMO arrangement for light general aviation aircraft.");
