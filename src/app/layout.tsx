...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}><body><Header /><main id="main-content">{children}</main><Footer /><MobileContactBar /><StructuredData /></body></html>;
}
